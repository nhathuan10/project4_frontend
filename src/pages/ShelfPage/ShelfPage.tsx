            ...
            <div className='mt-3'>
                <nav>
                    <div className='nav nav-tabs' id='nav-tab>' role='tablist'>
                        <button className='nav-link active background-main-color' id='nav-loans-tab' data-bs-toggle='tab'
                            data-bs-target='#nav-loans' type='button' role='tab' aria-controls='nav-loans' aria-selected='true'
                        >
                            Loan
                        </button>
                        <button className='nav-link background-main-color' id='nav-history-tab' data-bs-toggle='tab'
